...
#include "QFsm/Back/Aux/Detail/TypeTraits/HasCallOperator.hpp"
...
template<typename TStateInit, typename TEvent, typename TStateTarget, typename TAction, typename TGuard>
class Transition<TStateInit, TEvent, TStateTarget, TAction, TGuard, typename boost::disable_if< Back::Aux::Detail::TypeTraits::HasCallOperator<TAction, bool(const TEvent&)> >::type>
    : public Transition_<TStateInit, TEvent, TStateTarget, TAction, TGuard>
{ };

template<typename TStateInit, typename TEvent, typename TStateTarget, typename TGuard, typename TAction>
class Transition<TStateInit, TEvent, TStateTarget, TAction, TGuard, typename boost::enable_if< Back::Aux::Detail::TypeTraits::HasCallOperator<TGuard, bool(const TEvent&)> >::type>
    : public Transition_<TStateInit, TEvent, TStateTarget, TAction, TGuard>
{ };

template<typename TStateInit, typename TEvent, typename TStateTarget, typename TGuard>
class Transition<TStateInit, TEvent, TStateTarget, None, TGuard, typename boost::enable_if< Back::Aux::Detail::TypeTraits::HasCallOperator<TGuard, bool(const TEvent&)> >::type>
    : public Transition_<TStateInit, TEvent, TStateTarget, None, TGuard>
{ };

template<typename TStateInit, typename TEvent, typename TStateTarget, typename TAction>
class Transition<TStateInit, TEvent, TStateTarget, TAction, None, typename boost::disable_if< Back::Aux::Detail::TypeTraits::HasCallOperator<TAction, bool(const TEvent&)> >::type>
    : public Transition_<TStateInit, TEvent, TStateTarget, TAction, None>
{ };
#else
template<typename TStateInit, typename TEvent, typename TStateTarget, typename TAction = None, typename TGuard = None>
class Transition : public Transition_<TStateInit, TEvent, TStateTarget, TAction, TGuard>
{ };
#endif
